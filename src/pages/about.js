      ...
      <div className="flex flex-wrap">
        <div className="flex items-center justify-center w-full md:w-1/2">
          <div className="max-w-sm mx-auto p-4 text-xl">
            ...
            <p>
              Aspiring Minds Educational Intervention (Aspiring Minds) has
              emerged from experience gleaned over 40 years of teaching and
              observing young people learn and develop both within and outside
        ...
        <div className="font-sans max-w-md p-4 self-start text-grey-darkest text-xl">
          <div>
            <p>
              ...
              which builds a respectful and tolerant atmosphere among the
              students and between the students and staff.
            </p>
            <p>
              The improvement in students’ self-esteem and confidence is
              extremely gratifying to all involved.
            </p>
          </div>
        </div>
      </Skew>
